...
<div class="brand">
    <a href="#" class="brand-logo">
        <span class="brand-img">
            <span class="brand-img-text text-theme"><i class="bi bi-heart text-danger"></i></span>
        </span>
        <span class="brand-text">ERP SUPPORT SYSTEM</span>
    </a>
</div>
    ...
    <div class="menu-item dropdown dropdown-mobile-full">
        <a href="#" data-bs-toggle="dropdown" data-bs-display="static" class="menu-link">
            <div class="menu-img online">
                <img src="/inforLN/assets/img/user/user.png" alt="Profile" height="60" />
            </div>
            <!-- <div class="menu-text d-sm-block d-none"><span class="__cf_email__"
                    data-cfemail="b3c6c0d6c1ddd2ded6f3d2d0d0dcc6ddc79dd0dcde">[email&#160;protected]</span>
            </div> -->
        </a>
        <div class="dropdown-menu dropdown-menu-end me-lg-3 fs-11px mt-1">
            <a class="dropdown-item d-flex align-items-center" href="http://168.168.1.23/inforln/smtt/users_control/profile/">PROFILE <i
            ...
            <a class="dropdown-item d-flex align-items-center" href="/inforLN/logout.php">LOGOUT <i
